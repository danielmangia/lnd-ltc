...
var file_lightning_proto_rawDesc = []byte{
	...
	0x22, 0xbb, 0x03, 0x0a, 0x0d, 0x52, 0x6f, 0x75, 0x74, 0x69, 0x6e, 0x67, 0x50, 0x6f, 0x6c, 0x69,
	...
	0x6f, 0x6d, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x6f,
	0x63, 0x6b, 0x5f, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x1a, 0x40, 0x0a, 0x12,
	...
	0x69, 0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8d,
	0x09, 0x0a, 0x07, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x12, 0x2e, 0x0a, 0x04, 0x63, 0x6f,
	...
	0x0d, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x3f, 0x0a, 0x10, 0x63, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x32, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0x52, 0x0e, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x32, 0x22, 0x8b, 0x06, 0x0a, 0x0b, 0x46,
	...
	0x44, 0x61, 0x74, 0x61, 0x22, 0xb4, 0x03, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*ChannelUpdate2)(nil),                                      // 207: lnrpc.ChannelUpdate2
...
var file_lightning_proto_depIdxs = []int32{
	...
	225, // 61: lnrpc.PendingChannelsResponse.pending_open_channels:type_name -> lnrpc.PendingChannelsResponse.PendingOpenChannel
	228, // 62: lnrpc.PendingChannelsResponse.pending_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ClosedChannel
	229, // 63: lnrpc.PendingChannelsResponse.pending_force_closing_channels:type_name -> lnrpc.PendingChannelsResponse.ForceClosedChannel
	226, // 64: lnrpc.PendingChannelsResponse.waiting_close_channels:type_name -> lnrpc.PendingChannelsResponse.WaitingCloseChannel
	...
	230, // 72: lnrpc.WalletBalanceResponse.account_balance:type_name -> lnrpc.WalletBalanceResponse.AccountBalanceEntry
	...
	231, // 82: lnrpc.QueryRoutesRequest.dest_custom_records:type_name -> lnrpc.QueryRoutesRequest.DestCustomRecordsEntry
	...
	232, // 89: lnrpc.Hop.custom_records:type_name -> lnrpc.Hop.CustomRecordsEntry
	...
	233, // 94: lnrpc.LightningNode.features:type_name -> lnrpc.LightningNode.FeaturesEntry
	234, // 95: lnrpc.LightningNode.custom_records:type_name -> lnrpc.LightningNode.CustomRecordsEntry
	235, // 96: lnrpc.RoutingPolicy.custom_records:type_name -> lnrpc.RoutingPolicy.CustomRecordsEntry
	...
	236, // 99: lnrpc.ChannelEdge.custom_records:type_name -> lnrpc.ChannelEdge.CustomRecordsEntry
	...
	237, // 103: lnrpc.NodeMetricsResponse.betweenness_centrality:type_name -> lnrpc.NodeMetricsResponse.BetweennessCentralityEntry
	...
	238, // 108: lnrpc.NodeUpdate.features:type_name -> lnrpc.NodeUpdate.FeaturesEntry
	...
	239, // 120: lnrpc.Invoice.features:type_name -> lnrpc.Invoice.FeaturesEntry
	240, // 121: lnrpc.Invoice.amp_invoice_state:type_name -> lnrpc.Invoice.AmpInvoiceStateEntry
	7,   // 122: lnrpc.InvoiceHTLC.state:type_name -> lnrpc.InvoiceHTLCState
	241, // 123: lnrpc.InvoiceHTLC.custom_records:type_name -> lnrpc.InvoiceHTLC.CustomRecordsEntry
	...
	242, // 135: lnrpc.PayReq.features:type_name -> lnrpc.PayReq.FeaturesEntry
	...
	243, // 151: lnrpc.ListPermissionsResponse.method_permissions:type_name -> lnrpc.ListPermissionsResponse.MethodPermissionsEntry
	...
	207, // 154: lnrpc.Failure.channel_update_2:type_name -> lnrpc.ChannelUpdate2
	...
	175, // 162: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	175, // 163: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	106, // 171: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	111, // 173: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	175, // 174: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	135, // 175: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	175, // 176: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	175, // 177: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	152, // 178: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	175, // 179: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	202, // 180: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	112, // 181: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	115, // 182: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	...
	107, // 199: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	62,  // 200: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	109, // 201: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	69,  // 202: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	94,  // 203: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	94,  // 204: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	91,  // 205: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	104, // 206: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	...
	169, // 209: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	...
	153, // 214: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	158, // 215: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	157, // 216: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	160, // 217: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	173, // 218: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	163, // 219: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	165, // 220: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	166, // 221: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	131, // 222: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	133, // 223: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	136, // 224: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	125, // 225: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	117, // 226: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	137, // 227: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	139, // 228: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	141, // 229: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	171, // 230: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	176, // 231: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	179, // 232: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	182, // 233: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	185, // 234: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	188, // 235: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	189, // 236: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	191, // 237: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	193, // 238: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	196, // 239: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	198, // 240: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	200, // 241: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	203, // 242: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	...
	113, // 249: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	116, // 250: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
